...
eulergamma = 0.5772156649015328606065120900824024;
mtsun = 4.92549095e-6 # this is G Msun/c^3 in seconds
Rs = 1476.68 #GMsun/c^2
Gpc=3.0857e25 #m
...
try:
#   m1=float(raw_input('m1z (in solar masses):'))
    m1=float(raw_input())
#   print m1
except ValueError:
    print "Not a number"
...
try:
#   m2=float(raw_input('m2z (in solar masses):'))
    m2=float(raw_input())
#   print m2
except ValueError:
    print "Not a number"
...
#Amp=Amp*mtsun*Rs*(m1+m2)**2/Gpc #amplitude at dL = 1 Gpc
Amp=Amp*mtsun*Rs
